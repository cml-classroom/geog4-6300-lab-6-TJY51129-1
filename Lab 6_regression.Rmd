...
{Discussion here}
1. Rainfall (`rain_20_sum`):
   - Shows the strongest positive association with NDVI.
   - Explains 42.73% of the variance in NDVI.
   - Highlights rainfall as a critical driver of vegetation.
